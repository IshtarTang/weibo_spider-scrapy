...
配置文件中，灰框内为不用动的，蓝框内为必填项，橙框内为选填功能项
 ...
 <img src="%E7%AC%94%E8%AE%B0%E5%9B%BE/README/1710668227549.png" alt="1710668227549" style="zoom:67%;" />
...
假如你爬了A的微博主页，其中wb_result.json中为A发过的所有微博，r_wb_result.json中为A所有转发微博的源微博，如果你将`get_rwb_detail`设为0，则不会有r_wb_result.json，而是sr_wb_result.json。
